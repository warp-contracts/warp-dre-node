------------------------------------------------------------------------------
-- 2b. Warpy Summary Tables - client export
-- This is a script that generates data required by client using tables generated using pgWarpySummaryTables.sql
...
sha256(lower(sumu.wallet_address)::bytea) as wallet,
sumu.messages_count,
